...
`yarn e2e-local-open --env browser-password=<your-password-here>`. The name `browser-password` is a bit misleading. It's actually the password for connecting to Neo4j we just mentioned via bolt portocol. 
